...
for i in range(4):
	cipherKey.append(input("Enter ROW "+str(i+1)+" from cipher Key (0 0 0 0) : ").split())

rcon = input("Enter rcon : ")

rotWord = []
rotWord.append(cipherKey[1][3])
rotWord.append(cipherKey[2][3])
rotWord.append(cipherKey[3][3])
rotWord.append(cipherKey[0][3])

# print(rotWord)

rotWord.clear()

rotWord.append(sbox[cipherKey[1][3]])
rotWord.append(sbox[cipherKey[2][3]])
rotWord.append(sbox[cipherKey[3][3]])
rotWord.append(sbox[cipherKey[0][3]])
...
temp[0][0] = hex(int(rotWord[0], 16)^int(rcon, 16)^int(cipherKey[0][0], 16))[2:].rjust(2,"0")
temp[0][1] = hex(int(rotWord[1], 16)^int("00", 16)^int(cipherKey[1][0], 16))[2:].rjust(2,"0")
temp[0][2] = hex(int(rotWord[2], 16)^int("00", 16)^int(cipherKey[2][0], 16))[2:].rjust(2,"0")
temp[0][3] = hex(int(rotWord[3], 16)^int("00", 16)^int(cipherKey[3][0], 16))[2:].rjust(2,"0")

temp[1][0] = hex(int(temp[0][0], 16)^int(cipherKey[0][1], 16))[2:].rjust(2,"0")
temp[1][1] = hex(int(temp[0][1], 16)^int(cipherKey[1][1], 16))[2:].rjust(2,"0")
temp[1][2] = hex(int(temp[0][2], 16)^int(cipherKey[2][1], 16))[2:].rjust(2,"0")
temp[1][3] = hex(int(temp[0][3], 16)^int(cipherKey[3][1], 16))[2:].rjust(2,"0")

temp[2][0] = hex(int(temp[1][0], 16)^int(cipherKey[0][2], 16))[2:].rjust(2,"0")
temp[2][1] = hex(int(temp[1][1], 16)^int(cipherKey[1][2], 16))[2:].rjust(2,"0")
temp[2][2] = hex(int(temp[1][2], 16)^int(cipherKey[2][2], 16))[2:].rjust(2,"0")
temp[2][3] = hex(int(temp[1][3], 16)^int(cipherKey[3][2], 16))[2:].rjust(2,"0")

temp[3][0] = hex(int(temp[2][0], 16)^int(cipherKey[0][3], 16))[2:].rjust(2,"0")
temp[3][1] = hex(int(temp[2][1], 16)^int(cipherKey[1][3], 16))[2:].rjust(2,"0")
temp[3][2] = hex(int(temp[2][2], 16)^int(cipherKey[2][3], 16))[2:].rjust(2,"0")
temp[3][3] = hex(int(temp[2][3], 16)^int(cipherKey[3][3], 16))[2:].rjust(2,"0")
...
rconDict = {"01":"1","02":"2","04":"3","08":"4","10":"5","20":"6","40":"7","80":"8","1b":"9","36":"10"}
print("Round "+rconDict[rcon]+" key table : ")
print(result)		
