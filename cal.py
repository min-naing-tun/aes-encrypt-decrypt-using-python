...
def calculate(l1, l2):
	...
	for i in range(4): # convert hex to binary
		l1[i] = bin(int(l1[i], 16))[2:].rjust(8, "0")
		l2[i] = bin(int(l2[i], 16))[2:].rjust(8, "0")
...
# print(calculate(["0e", "0b", "0d", "09"], ["40", "d4", "e4", "a5"]))
# print(hex(int(calculate(["0e", "0b", "0d", "09"], ["40", "d4", "e4", "a5"]), 2))[2:])